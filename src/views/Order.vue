  ...
  <el-card class="order-container">
    <template #header>
      <div class="header">
        ...
        <el-button type="primary"  @click="handleConfig()"><el-icon><HomeFilled /></el-icon>配货完成</el-button>
        <el-button type="primary"  @click="handleSend()"><el-icon><HomeFilled /></el-icon>出库</el-button>
        <el-button type="primary"  @click="handleClose()"><el-icon><Delete /></el-icon>配货完成</el-button>
      </div>
    </template>
    <el-table
      v-loading="loading"
    ...
    >
      ...
      >
       <template #default="scope">
        ...
        >
          <template #reference>
            <a style="cursor: pointer; margin-right: 10px">出货</a>
          </template>
        </el-popconfirm>
        <el-popconfirm
